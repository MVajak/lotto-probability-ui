...
export const vikingLottoWinningNumberStatsSelector = createSelector(
...
export const vikingLottoSecWinningNumberStatsSelector = createSelector(
  [lottoProbabilityResultSelector],
  (result): NumberStat[] => {
    const probabilityNumbers = result.probabilityNumbers[0];
...
export const vikingLottoMainNumbersSelector = createSelector(
  [lottoProbabilityResultSelector],
