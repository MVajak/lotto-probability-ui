...
import {
  euroJackpotLottoMainNumbersSelector,
  euroJackpotLottoSecWinningNumberStatsSelector,
  euroJackpotLottoWinningNumberStatsSelector,
} from './selectors';

export const EuroJackpotLottoCard = () => {
  const dispatch = useDispatch<AppDispatch>();
  const isLoading = useSelector(isLoadingSelector);
  const lottoMainNumbers = useSelector(euroJackpotLottoMainNumbersSelector);
