    ...
    >
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute top-[8%] left-[5%]">
          <h3 className="mb-2 text-primary-foreground text-title-default-bold lg:text-display-small-bold">
            {t('authLayout.title')}
          </h3>
        ...
        <div className="absolute bottom-[8%] left-[5%]">
          <p className="text-body-small text-primary-foreground/60 lg:text-body-large">{t('authLayout.features')}</p>
        </div>
      </div>

      <Card
        className="relative z-10 m-[18px] flex w-full flex-col justify-center p-6 shadow-none md:shadow-sm"
