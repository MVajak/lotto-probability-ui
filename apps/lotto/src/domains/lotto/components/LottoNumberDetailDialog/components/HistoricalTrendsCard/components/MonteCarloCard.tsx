...
interface MonteCarloCardProps {
  monteCarlo: NonNullable<NumberDetailDto['monteCarlo']>;
}
        ...
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="relative h-10">
              {/* Background track */}
              <div className="absolute inset-x-0 top-1/2 h-3 -translate-y-1/2 rounded-full bg-muted" />

              {/* Expected range highlight */}
              <div
                className="absolute top-1/2 h-3 -translate-y-1/2 rounded-full bg-primary/20 border border-primary/40"
                style={{
              ...
              <div
                className="absolute -bottom-2 text-label-small text-muted-foreground"
              ...
              <div
                className={cn(
                  'absolute top-1/2 -translate-x-1/2 -translate-y-3 flex flex-col items-center'
                )}
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4 text-body-small">
            <div className="flex items-center gap-2">
              <div className="h-3 w-8 rounded bg-primary/20 border border-primary/40" />
