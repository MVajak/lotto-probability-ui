...
export const VikingLottoCard = () => {
  ...
  const isCurrentLottoType = searchParams.lottoType === LottoType.VIKINGLOTTO;
  ...
  return (
    <div className="flex flex-col gap-4">
      <LottoInfo lottoType={LottoType.VIKINGLOTTO} linkBuyTickets={LINK_BUY_TICKETS} linkGameRules={LINK_GAME_RULES} />
